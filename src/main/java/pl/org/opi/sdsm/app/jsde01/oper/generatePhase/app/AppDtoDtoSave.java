...
public class AppDtoDtoSave {
    ...
    public void exec() {
        ...
        var cfg = _Jsde01GenUtil.getModel().getConfigModel().getGenAppDtoDtoFullFile();

        try {
            FileUtils.write(
                    new File(_Jsde01GenUtil.getModel().getConfigModel().getGenAppDtoDtoFullFile()),
