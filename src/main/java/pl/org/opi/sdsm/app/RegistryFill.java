...
import pl.org.opi.sdsm.app.zestawienie_a.ZestawienieAGenDef;
...
public class RegistryFill {
    ...
    public static void fill(LinkedHashMap<String, GenDef> definitionMap) {
        definitionMap.put(ZestawienieAGenDef.CODE, new ZestawienieAGenDef());
        //definitionMap.put(EmptyGenDef.CODE, new EmptyGenDef());
